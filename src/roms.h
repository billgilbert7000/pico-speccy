...
// +3 (divIDE): generated by tools/rom_pack.py plus3div — declares whatever banks
// that build of the ROM needs of its own and names the rest through PLUS3DIV_*
// macros (see Config::requestMachine).
#include "roms/plus3div/plus3div_roms.h"
#endif
